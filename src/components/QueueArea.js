...
export default function QueueArea({ members = [] }) {
  ...
  const getAvailableMembers = () => {
    ...
    const courtsMembers = allCourts.flatMap((court) => court.members.map((m) => m.id));
      ...
      {showMemberModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col">
            {/* 彈窗標題 */}
            <div className="bg-gradient-to-r from-[#3e41e2] to-[#37cacf] text-white p-4 rounded-t-2xl flex items-center justify-between">
              <div>
            ...
            {modalSelectedMembers.length > 0 && (
              <div className="bg-blue-50 border-b-2 border-blue-200 p-3">
                <p className="text-blue-800 font-semibold text-center">已選擇 {modalSelectedMembers.length} 位隊員</p>
              </div>
            )}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs font-semibold text-blue-600">Lv.{member.level}</span>
                        </div>
                      </div>
                    );
                  })}
            ...
            <div className="border-t border-gray-200 p-4 flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 disabled:from-gray-300 disabled:to-gray-400 text-white font-semibold rounded-lg transition-all disabled:cursor-not-allowed"
              >
