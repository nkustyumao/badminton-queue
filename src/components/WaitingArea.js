...
export default function WaitingArea({ members = [], selectedMembers = [], onToggleMember, onClearSelection }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-auto flex flex-col hover:shadow-md transition-shadow duration-300">
      {/* 區塊標題 */}
      <div className="bg-gradient-to-r from-[#08b834] to-[#e5e77a] text-white p-4 flex items-center justify-between">
        ...
        {isLoading ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <Clock className="w-20 h-20 mx-auto mb-4 text-[#08b834] opacity-50" />
                ...
                >
                  ...
                  <div className="mb-3 pr-8">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-sm font-semibold  text-clip text-transparent bg-clip-text bg-gradient-to-r from-[#667eea] to-[#764ba2]">
                        總程度: {totalLevel}
                      </span>
                      <span className="text-sm text-gray-500">( {court.members.length} / 4 )</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {Array.from({ length: 4 - court.members.length }).map((_, index) => (
                      <div
                        ...
                        className="border-2 border-dashed border-gray-300 hover:border-orange-400 hover:bg-orange-50 rounded-lg p-2 text-center text-gray-400 hover:text-orange-600 text-sm cursor-pointer transition-all duration-200 lg:pointer-events-none lg:opacity-50"
                      >
                        <span className="text-xs lg:hidden">
                          <Plus className="w-4 h-4 inline-block mr-1" /> 點擊加入
                        </span>
